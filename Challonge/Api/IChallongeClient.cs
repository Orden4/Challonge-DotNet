...
namespace Challonge.Api
{
	...
	/// </summary>
	internal interface IChallongeClient
	{
		/// <summary>
		...
		Task<IEnumerable<Tournament>> GetTournamentsAsync(TournamentState? state = null, TournamentType? type = null,
		...
		Task<Tournament> CreateTournamentAsync(TournamentInfo tournamentInfo);
		...
		Task<Tournament> GetTournamentByUrlAsync(string url);
		...
		Task<Tournament> UpdateTournamentAsync(string tournament, TournamentInfo tournamentInfo);
		...
		/// <param name="tournamentInfo">The new details of the tournament.</param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> UpdateTournamentAsync(Tournament tournament, TournamentInfo tournamentInfo);
		...
		Task DeleteTournamentAsync(string tournament);
		...
		Task<Tournament> ProcessTournamentCheckInsAsync(string tournament);
		...
		/// <returns>A task representing the the updated tournament.</returns>
		Task<Tournament> ProcessTournamentCheckInsAsync(Tournament tournament);
		...
		/// </param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> AbortTournamentCheckInAsync(string tournament);
		...
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> AbortTournamentCheckInAsync(Tournament tournament);
		...
		/// </param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> StartTournamentAsync(string tournament);
		...
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> StartTournamentAsync(Tournament tournament);
		...
		/// </param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> FinalizeTournamentAsync(string tournament);
		...
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> FinalizeTournamentAsync(Tournament tournament);
		...
		/// </param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> ResetTournamentAsync(string tournament);
		...
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> ResetTournamentAsync(Tournament tournament);
		...
		/// </param>
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> OpenTournamentForPredictionsAsync(string tournament);
		...
		/// <returns>A task representing the updated tournament.</returns>
		Task<Tournament> OpenTournamentForPredictionsAsync(Tournament tournament);
		...
		Task<IEnumerable<Participant>> GetParticipantsAsync(string tournament);
		...
		/// <returns>A task representing the tournament's participants.</returns>
		Task<IEnumerable<Participant>> GetParticipantsAsync(Tournament tournament);
		...
		Task<Participant> CreateParticipantAsync(string tournament, ParticipantInfo participantInfo);
		...
		/// <param name="participantInfo">The details of the new participant.</param>
		/// <returns>A task representing the new participant.</returns>
		Task<Participant> CreateParticipantAsync(Tournament tournament, ParticipantInfo participantInfo);
		...
		Task<IEnumerable<Participant>> CreateParticipantsAsync(string tournament, IEnumerable<ParticipantInfo> participantInfos);
		...
		/// <param name="participantInfos">The details of the new participants.</param>
		/// <returns>A task representing the new participants</returns>
		Task<IEnumerable<Participant>> CreateParticipantsAsync(Tournament tournament, IEnumerable<ParticipantInfo> participantInfos);
		...
		Task<Participant> GetParticipantAsync(string tournament, long participantId);
		...
		/// <param name="participantId">The participant's ID.</param>
		/// <returns>A task representing the participant.</returns>
		Task<Participant> GetParticipantAsync(Tournament tournament, long participantId);
		...
		Task<Participant> UpdateParticipantAsync(Participant participant, ParticipantInfo participantInfo);
		...
		/// <returns>A task representing the updated participant.</returns>
		Task<Participant> CheckInParticipantAsync(Participant participant);
		...
		/// <returns>A task representing the updated participant.</returns>
		Task<Participant> UndoCheckInParticipantAsync(Participant participant);
		...
		/// </param>
		/// <returns>An empty task.</returns>
		Task ClearParticipantsAsync(string tournament);
		...
		/// <returns>An empty task.</returns>
		Task ClearParticipantsAsync(Tournament tournament);
		...
		Task<IEnumerable<Participant>> RandomizeParticipantsAsync(string tournament);
		...
		/// <returns>A task representing the updated participants.</returns>
		Task<IEnumerable<Participant>> RandomizeParticipantsAsync(Tournament tournament);
		...
		Task<IEnumerable<Match>> GetMatchesAsync(Tournament tournament, MatchState matchState = MatchState.All,
		...
		Task<Match> GetMatchAsync(Tournament tournament, long matchId);
		...
		Task<Match> UpdateMatchAsync(Match match, MatchInfo matchInfo);
		...
		/// <returns>A task representing the updated match.</returns>
		Task<Match> ReopenMatchAsync(Match match);
		...
		/// <returns>A task representing the updated match.</returns>
		Task<Match> MarkMatchAsUnderwayAsync(Match match);
		...
		/// <returns>A task representing the updated match.</returns>
		Task<Match> UnmarkMatchAsUnderwayAsync(Match match);
		...
		Task<IEnumerable<MatchAttachment>> GetMatchAttachmentsAsync(Match match);
		...
		Task<MatchAttachment> CreateMatchAttachmentAsync(Match match, MatchAttachmentInfo matchAttachmentInfo);
		...
		Task<MatchAttachment> GetMatchAttachmentAsync(Match match, long matchAttachmentId);
		...
		Task<MatchAttachment> UpdateMatchAttachmentAsync(Match match,
		...
		/// <returns>An empty task.</returns>
		Task DeleteMatchAttachmentAsync(Match match, MatchAttachment matchAttachment);
	}
}
